...
const TypographySection = () => {
  const handleMontserratDownload = () => {
    window.open('https://fonts.google.com/specimen/Montserrat', '_blank');
  };

  const handleInterDownload = () => {
    window.open('https://fonts.google.com/specimen/Inter', '_blank');
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="flex justify-center mt-6">
            <button 
              onClick={handleMontserratDownload}
              className="inline-flex items-center gap-2 px-8 py-3 bg-muted/30 hover:bg-muted/50 rounded-full text-base font-medium transition-all hover:scale-105"
            >
              <Download className="h-5 w-5" />
              <span>Descargar Montserrat</span>
            </button>
          </div>
        </div>
        ...
        <div>
          <div className="mb-8">
            ...
            <p className="text-sm text-muted-foreground">
              Inter es nuestra fuente principal para titulares web y contenido digital. Se debe utilizar en negrita para los
              encabezados principales y semi-negrita para subtítulos destacados.
            </p>
          </div>
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              o medio para garantizar óptima legibilidad en pantallas.
            </p>
          </div>
          <div className="flex justify-center mt-6">
            <button 
              onClick={handleInterDownload}
              className="inline-flex items-center gap-2 px-8 py-3 bg-muted/30 hover:bg-muted/50 rounded-full text-base font-medium transition-all hover:scale-105"
            >
              <Download className="h-5 w-5" />
              <span>Descargar Inter</span>
            </button>
          </div>
        </div>
      </div>
